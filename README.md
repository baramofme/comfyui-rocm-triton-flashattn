...
*   **Optimized Performance**: Powered by ROCm 7.14 + PyTorch 2.12.
...
| `COMFYUI_ARGS` | `--use-flash-attention` | Extra command line arguments passed to ComfyUI |
